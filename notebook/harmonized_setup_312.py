...
project_name: str = "Brightway paper v2.1"
...
ecoinvent_db_name_xml_migrated: str = "ecoinvent v3.12 Cut-off - XML - unregionalized (migrated to SimaPro biosphere)"
...
agrifootprint_db_name_updated_simapro: str = "AgriFootprint v7.0.1 - SimaPro - unregionalized (XML background ecoinvent v3.12)"
...
salca_db_name_updated_simapro: str = "SALCA Database v3.12 - SimaPro - unregionalized (XML background ecoinvent v3.12)"
